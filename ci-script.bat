...
echo Running tests...
pytest python_project\tests\ --junitxml=python_project\tests\reports\results.xml --cov=python_project --cov-report=xml:python_project\tests\reports\coverage.xml
